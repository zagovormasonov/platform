-- Упрощенная версия создания системы уведомлений
...
-- ========================================
-- ЧАСТЬ 5: Функция для создания уведомлений о бронировании
-- ========================================
...
DROP TRIGGER IF EXISTS trigger_update_booking_notification ON public.bookings;
